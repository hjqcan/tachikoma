...
Consumed by remote clients of `tachikoma-engined` (see `@hjqcan/tachikoma-server`). The contract
evolves additively only; consumers must tolerate unknown event types.
